  ...
  if (detailError || !challenge) {
    return (
      <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-8 text-center text-red-400">
        <p>{detailError || 'Kh├┤ng t├¼m thß║Ñy b├ái thi'}</p>
        <Link to="/challenges" className="mt-4 inline-block px-4 py-2 bg-surface-dark rounded-lg text-white">Quay lß║íi</Link>
      </div>
    );
  }
