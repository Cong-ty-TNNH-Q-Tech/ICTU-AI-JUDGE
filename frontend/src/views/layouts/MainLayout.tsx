            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              {isAuthenticated ? (
                <div className="relative" ref={dropdownRef}>
                  ...
                  >
                    <div className="w-7 h-7 rounded-full bg-gradient-to-br from-primary-400 to-primary-600 flex items-center justify-center text-[11px] font-bold text-white ring-2 ring-surface dark:ring-surface-dark">
